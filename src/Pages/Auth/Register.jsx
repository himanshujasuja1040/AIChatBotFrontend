...
export default function RegisterPage() {
    ...
    const [formData, setFormData] = useState(null); // To hold form data
    ...
    const verifyOtp = () => {
        ...
        setTimeout(() => {
            if (enteredOtp === "1234") { // Simulate correct OTP
                ...
                login(formData); // Use the saved form data to update the store
        ...
        <div className="auth-container">
            <div className="auth-card">
                <div className="auth-header">
                    ...
                    <h1 className="auth-title">{step === 1 ? "Create your account" : "Verify your number"}</h1>
                    <p className="auth-subtitle">
                        {step === 1 ? "Welcome! Please fill in the details." : "Enter the 4-digit code we sent you."}
                    </p>
                </div>
